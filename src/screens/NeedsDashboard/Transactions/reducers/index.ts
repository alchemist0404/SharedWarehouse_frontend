...
import { transactionsReducer } from '@screens/NeedsDashboard/Transactions/containers/TransactionsPage/reducer';
...
const reqs = (state: RootState) => state.needsDashboard.transactions.requests;
const data = (state: RootState) => state.needsDashboard.transactions.data;
