...
export interface IGetInTouchFormProps {
...
const GetInTouchForm: React.FC<IGetInTouchFormProps & FormikProps<IFormValues>> = (
...
export default withFormik<IGetInTouchFormProps, IFormValues>({
