      ...
      if (!data.nested) {
        actions.push(
          ...
          },
          {
            ...
            pattern: '/* PlopJS import placeholder. Do not remove */',
            template: 'import {{camelCase name}} from \'@screens/{{pascalCase name}}/reducers\';'
          },
          {
            type: 'append',
            path: 'src/reducers/index.ts',
        ...
        if (data.isRoutingScreen) {
          actions.push(
            ...
            },
            {
              ...
              path: 'src/reducers/index.ts',
              pattern: '/* PlopJS import placeholder. Do not remove */',
              template: 'import {{camelCase rootCatalog}} from \'@screens/{{pascalCase rootCatalog}}/{{pascalCase name}}/reducers\';'
            },
            {
              type: 'append',
              path: 'src/reducers/index.ts',
              pattern: '/* PlopJS reducer placeholder. Do not remove */',
              template: '  {{camelCase rootCatalog}},'
            }
          );
        } else {
